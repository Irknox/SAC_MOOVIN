...
function LoginInner() {
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center px-4">
      ...
      />
      <div className="w-full max-w-lg rounded-md border-2 border-[#0142a2ff] bg-[#031745ff] p-6 shadow-xl">
        <form onSubmit={onSubmit} className="grid gap-4 w-full">
          <label
            htmlFor="manager-key"
            className="block text-center text-base sm:text-lg font-semibold text-white"
          >
            Manager Key
          </label>
          <div className="flex w-full">
            <span className="inline-flex items-center px-3 text-sm sm:text-base text-gray-900 bg-gray-200 border border-e-0 border-gray-300 rounded-s-md dark:bg-gray-600 dark:text-gray-300 dark:border-gray-600">
              <svg
                className="h-5 w-5"
                aria-hidden="true"
            ...
            <input
              ...
              required
              className="w-full min-w-0 rounded-e-md bg-gray-50 border border-gray-300 text-gray-900
                         focus:ring-blue-500 focus:border-blue-500 block text-base sm:text-lg
                         p-3 sm:p-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
          ...
          <button
            disabled={loading}
            type="submit"
            className="w-full sm:w-auto justify-center text-white font-medium rounded-md
                       text-base sm:text-lg px-6 py-3 bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700
