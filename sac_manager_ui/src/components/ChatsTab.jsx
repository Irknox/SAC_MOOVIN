      ...
      >
        {lastMessages.map((entry) => (
          ...
          >
            ...
            >
              {entry.mensaje_saliente || entry.mensaje_entrante}
              {/*<span className="inline-flex items-center justify-center p-0.5 w-5 h-5 ms-2 text-xs font-semibold text-blue-800 bg-blue-400 rounded-full">
                <svg
